...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, (int)FormaGeometrica.enuIdioma.Castellano);
        ...
        public void TestResumenListaConMasCuadrados()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, (int)FormaGeometrica.enuIdioma.Ingles);
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, (int)FormaGeometrica.enuIdioma.Ingles);
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, (int)FormaGeometrica.enuIdioma.Castellano);
        ...
        public void TestResumenListaConVariosTipos() //SE AGREGARON EL TRAPECIO , EL RECTANGULO Y EL IDIOMA NUEVO.
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, (int)FormaGeometrica.enuIdioma.Portuges);

            Assert.AreEqual(
                "<h1>Relatório de formas</h1>2 quadrados | Area 29 | Perimetro 28 <br/>2 Círculos | Area 13,01 | Perimetro 18,06 <br/>3 Triángulos | Area 49,64 | Perimetro 51,6 <br/>1 Trapézios | Area 16,8 | Perimetro 16,4 <br/>1 Rectangulos | Area 8,4 | Perimetro 12,4 <br/>TOTAL:<br/>9 Formas Perimetro 126,46 Area 116,85",
                resumen);
        }
    }
}
